...
namespace SupplyDepotDomain.Migrations
{
    ...
    [Migration("20230311174953_AddedLocationToUserClass")]
    partial class AddedLocationToUserClass
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SupplyDepotDomain.Model.User", b =>
                {
                    ...
                    b.HasOne("SupplyDepotDomain.Model.Location", "LocationNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("SupplyDepotDomain.Model.Vendor", b =>
                {
                    ...
                    b.HasOne("SupplyDepotDomain.Model.Location", "RemitToLocation")
                        .WithMany("Vendors")
